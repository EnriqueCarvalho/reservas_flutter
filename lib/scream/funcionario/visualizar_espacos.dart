...
class VisualizarEspacos extends StatefulWidget {
...
class _HomePageState extends State<VisualizarEspacos> {
  var isLoading = false;
  ...
  _loadFromApi() async {
    ...
    var espacoService = EspacoService();
    await espacoService.getEspacos();
  ...
  _buildEmployeeListView() {
    return FutureBuilder(
      future: EspacoService().getEspacos(),
          ...
          return ListView.separated(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return ListTile(
                ...
                subtitle: Text('Capacidade: ${snapshot.data[index].qtdMax} - Valor: ${snapshot.data[index].valor} '),
              );
            },
